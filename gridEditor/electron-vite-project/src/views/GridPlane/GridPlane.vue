...
import model from '../../assets/grids/68-futuristic_trike_high-poly_2-fbx-7.4-binary-mit-animation/Futuristic_Trike_High-Poly_2-(FBX 7.4 binary mit Animation).fbx'
