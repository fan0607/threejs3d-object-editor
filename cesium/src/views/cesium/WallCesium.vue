...
async function init() {
  ...
  createWall(viewer, center);
}
function waterWebGL2(viewer, center) {
  const instance = new Cesium.GeometryInstance({
    geometry: new Cesium.RectangleGeometry({
      rectangle: Cesium.Rectangle.fromDegrees(center.x - 0.01, center.y - 0.01, center.x + 0.01, center.y + 0.01),
  ...
  /* viewer.camera.flyToBoundingSphere(
    new Cesium.BoundingSphere(
      Cesium.Cartesian3.fromDegrees(center.x, center.y, 10.0),
      9500.0
    )
  ); */
  viewer.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(center.x, center.y, 10.0),
    orientation: {
...
function createWall(viewer, center) {
  let aper = new Cesium.MaterialAppearance({
    material: new Cesium.Material({
      fabric: {
        uniforms: {
  ...
  let wall2 = new Cesium.WallGeometry({
    positions: Cesium.Cartesian3.fromDegreesArrayHeights([
      -95.5, 50.1, 10000.0,
      -95.6, 51.1, 10000.0,
      -95.7, 51.1, 10000.0,
  ...
  let primitive = new Cesium.Primitive({
    geometryInstances: [polygonInstance1,polygonInstance2,instance],
  ...
  viewer.camera.setView({
    destination: Cesium.Cartesian3.fromDegrees(center.x, center.y, 10000.0),
    orientation: {
      heading: Cesium.Math.toRadians(0.0),
      pitch: Cesium.Math.toRadians(-90.0),
      roll: 0.0,
