...
onMounted(()=>{
  ...
  axios.get('https://kc3.kcgis.cn:9001/2022/scqt/all/empty_line.json').then((response)=>{
 ...
 handler.setInputAction(function(movement) {
    ...
    // let names = Cesium.Cesium3DTileFeature.getPropertyInherited()
    // let names = Cesium.Cesium3DTileFeature.getPropertyNames
